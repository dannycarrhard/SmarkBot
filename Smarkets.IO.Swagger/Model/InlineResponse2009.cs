...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(bool? enabled = default(bool?))
        {
            // to ensure "enabled" is required (not null)
            if (enabled == null)
            {
                throw new InvalidDataException("enabled is a required property for InlineResponse2009 and cannot be null");
            }
            else
            {
