...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20065 :  IEquatable<InlineResponse20065>, IValidatableObject
    {
        ...
        public InlineResponse20065(bool? showAlert = default(bool?))
        {
            // to ensure "showAlert" is required (not null)
            if (showAlert == null)
            {
                throw new InvalidDataException("showAlert is a required property for InlineResponse20065 and cannot be null");
            }
            else
            {
