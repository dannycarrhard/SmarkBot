...
namespace IO.Swagger.Model
{
        ...
        public partial class Body22 :  IEquatable<Body22>, IValidatableObject
    {
        ...
        public Body22(string currentUrl = default(string), string uniqueIdentifier = default(string))
        {
            // to ensure "currentUrl" is required (not null)
            if (currentUrl == null)
            {
                throw new InvalidDataException("currentUrl is a required property for Body22 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("uniqueIdentifier is a required property for Body22 and cannot be null");
            }
            else
            {
