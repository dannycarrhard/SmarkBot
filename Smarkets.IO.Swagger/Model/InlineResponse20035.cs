...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20035 :  IEquatable<InlineResponse20035>, IValidatableObject
    {
        ...
        public InlineResponse20035(bool? required = default(bool?))
        {
            // to ensure "required" is required (not null)
            if (required == null)
            {
                throw new InvalidDataException("required is a required property for InlineResponse20035 and cannot be null");
            }
            else
            {
