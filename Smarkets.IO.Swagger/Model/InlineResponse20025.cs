...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20025 :  IEquatable<InlineResponse20025>, IValidatableObject
    {
        ...
        public InlineResponse20025(string email = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for InlineResponse20025 and cannot be null");
            }
            else
            {
                this.Email = email;
