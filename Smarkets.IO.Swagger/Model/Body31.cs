...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Body31 :  IEquatable<Body31>, IValidatableObject
    {
        /// <summary>
        /// Defines Interval
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Body31" /> class.
        /// </summary>
        /// <param name="interval">interval (required).</param>
        /// <param name="totalAllowance">totalAllowance (required).</param>
        public Body31(IntervalEnum interval = default(IntervalEnum), string totalAllowance = default(string))
        {
            // to ensure "interval" is required (not null)
            if (interval == null)
            {
                throw new InvalidDataException("interval is a required property for Body31 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalAllowance is a required property for Body31 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as Body31);
        }

        /// <summary>
        /// Returns true if Body31 instances are equal
        /// </summary>
        /// <param name="input">Instance of Body31 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Body31 input)
        {
            if (input == null)
                return false;
