...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20044 :  IEquatable<InlineResponse20044>, IValidatableObject
    {
        ...
        public InlineResponse20044(List<InlineResponse20044Codes> codes = default(List<InlineResponse20044Codes>))
        {
            // to ensure "codes" is required (not null)
            if (codes == null)
            {
                throw new InvalidDataException("codes is a required property for InlineResponse20044 and cannot be null");
            }
            else
            {
                this.Codes = codes;
        ...
        public List<InlineResponse20044Codes> Codes { get; set; }
