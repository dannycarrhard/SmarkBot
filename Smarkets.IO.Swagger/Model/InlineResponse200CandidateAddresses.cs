...
{
    /// <summary>
    /// InlineResponse200CandidateAddresses
    /// </summary>
    [DataContract]
        public partial class InlineResponse200CandidateAddresses :  IEquatable<InlineResponse200CandidateAddresses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse200CandidateAddresses" /> class.
        /// </summary>
        ...
        public InlineResponse200CandidateAddresses(string buildingName = default(string), string buildingNumber = default(string), string country = default(string), string flatNumber = default(string), string postcode = default(string), string street = default(string), string subStreet = default(string), string town = default(string))
        {
            // to ensure "country" is required (not null)
            if (country == null)
            {
                throw new InvalidDataException("country is a required property for InlineResponse200CandidateAddresses and cannot be null");
            }
            else
            {
            ...
            if (postcode == null)
            {
                throw new InvalidDataException("postcode is a required property for InlineResponse200CandidateAddresses and cannot be null");
            }
            else
            {
            ...
            if (street == null)
            {
                throw new InvalidDataException("street is a required property for InlineResponse200CandidateAddresses and cannot be null");
            }
            else
            {
                this.Street = street;
            ...
            if (town == null)
            {
                throw new InvalidDataException("town is a required property for InlineResponse200CandidateAddresses and cannot be null");
            }
            else
            {
                this.Town = town;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse200CandidateAddresses {\n");
        ...
        {
            return this.Equals(input as InlineResponse200CandidateAddresses);
        }

        /// <summary>
        /// Returns true if InlineResponse200CandidateAddresses instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse200CandidateAddresses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse200CandidateAddresses input)
        {
            if (input == null)
                return false;
