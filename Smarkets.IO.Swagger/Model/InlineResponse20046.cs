...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20046 :  IEquatable<InlineResponse20046>, IValidatableObject
    {
        ...
        public InlineResponse20046(List<InlineResponse20046Subscriptions> subscriptions = default(List<InlineResponse20046Subscriptions>))
        {
            // to ensure "subscriptions" is required (not null)
            if (subscriptions == null)
            {
                throw new InvalidDataException("subscriptions is a required property for InlineResponse20046 and cannot be null");
            }
            else
            {
        ...
        public List<InlineResponse20046Subscriptions> Subscriptions { get; set; }
