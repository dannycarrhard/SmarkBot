...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20063 :  IEquatable<InlineResponse20063>, IValidatableObject
    {
        ...
        public InlineResponse20063(InlineResponse20062Promotion promotion = default(InlineResponse20062Promotion))
        {
            // to ensure "promotion" is required (not null)
            if (promotion == null)
            {
                throw new InvalidDataException("promotion is a required property for InlineResponse20063 and cannot be null");
            }
            else
            {
