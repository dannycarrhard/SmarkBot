...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20024 :  IEquatable<InlineResponse20024>, IValidatableObject
    {
        ...
        public InlineResponse20024(DateTime? endDate = default(DateTime?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "endDate" is required (not null)
            if (endDate == null)
            {
                throw new InvalidDataException("endDate is a required property for InlineResponse20024 and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for InlineResponse20024 and cannot be null");
            }
            else
            {
                this.Type = type;
