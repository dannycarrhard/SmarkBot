...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20028 :  IEquatable<InlineResponse20028>, IValidatableObject
    {
        ...
        public InlineResponse20028(string pnl = default(string))
        {
            // to ensure "pnl" is required (not null)
            if (pnl == null)
            {
                throw new InvalidDataException("pnl is a required property for InlineResponse20028 and cannot be null");
            }
            else
            {
                this.Pnl = pnl;
