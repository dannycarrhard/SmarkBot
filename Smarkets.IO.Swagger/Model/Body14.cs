...
namespace IO.Swagger.Model
{
        ...
        public partial class Body14 :  IEquatable<Body14>, IValidatableObject
    {
        ...
        public Body14(string buildingName = default(string), string buildingNumber = default(string), string country = default(string), string flatNumber = default(string), string phone = default(string), string postcode = default(string), string street = default(string), string substreet = default(string), string town = default(string))
        {
            // to ensure "buildingName" is required (not null)
            if (buildingName == null)
            {
                throw new InvalidDataException("buildingName is a required property for Body14 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("buildingNumber is a required property for Body14 and cannot be null");
            }
            else
            {
            ...
            if (flatNumber == null)
            {
                throw new InvalidDataException("flatNumber is a required property for Body14 and cannot be null");
            }
            else
            {
            ...
            if (phone == null)
            {
                throw new InvalidDataException("phone is a required property for Body14 and cannot be null");
            }
            else
            {
                this.Phone = phone;
            ...
            if (postcode == null)
            {
                throw new InvalidDataException("postcode is a required property for Body14 and cannot be null");
            }
            else
            {
            ...
            if (street == null)
            {
                throw new InvalidDataException("street is a required property for Body14 and cannot be null");
            }
            else
            {
                this.Street = street;
            ...
            if (substreet == null)
            {
                throw new InvalidDataException("substreet is a required property for Body14 and cannot be null");
            }
            else
            {
            ...
            if (town == null)
            {
                throw new InvalidDataException("town is a required property for Body14 and cannot be null");
            }
            else
            {
                this.Town = town;
