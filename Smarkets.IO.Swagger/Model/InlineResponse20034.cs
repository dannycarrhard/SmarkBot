...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20034 :  IEquatable<InlineResponse20034>, IValidatableObject
    {
        ...
        public InlineResponse20034(string balance = default(string))
        {
            // to ensure "balance" is required (not null)
            if (balance == null)
            {
                throw new InvalidDataException("balance is a required property for InlineResponse20034 and cannot be null");
            }
            else
            {
