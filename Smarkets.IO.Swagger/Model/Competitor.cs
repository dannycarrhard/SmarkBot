...
namespace IO.Swagger.Model
{
        ...
        public partial class Competitor :  IEquatable<Competitor>, IValidatableObject
    {
        ...
        public Competitor(string eventId = default(string), string id = default(string), CompetitorsInfo info = default(CompetitorsInfo), string name = default(string), string shortCode = default(string), string shortName = default(string), string slug = default(string), TypeEnum? type = TypeEnum.None)
        {
