...
{
    /// <summary>
    /// WorldpayRegistrationIdDepositRequest
    /// </summary>
    [DataContract]
        public partial class WorldpayRegistrationIdDepositRequest :  IEquatable<WorldpayRegistrationIdDepositRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines ExpiryMonth
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorldpayRegistrationIdDepositRequest {\n");
        ...
        {
            return this.Equals(input as WorldpayRegistrationIdDepositRequest);
        }

        /// <summary>
        /// Returns true if WorldpayRegistrationIdDepositRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WorldpayRegistrationIdDepositRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorldpayRegistrationIdDepositRequest input)
        {
            if (input == null)
                return false;
