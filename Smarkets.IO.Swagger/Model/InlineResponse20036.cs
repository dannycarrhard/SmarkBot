...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20036 :  IEquatable<InlineResponse20036>, IValidatableObject
    {
        ...
        public InlineResponse20036(string redirectUri = default(string))
        {
            // to ensure "redirectUri" is required (not null)
            if (redirectUri == null)
            {
                throw new InvalidDataException("redirectUri is a required property for InlineResponse20036 and cannot be null");
            }
            else
            {
