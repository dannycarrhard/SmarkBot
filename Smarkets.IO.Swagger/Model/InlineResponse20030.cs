...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20030 :  IEquatable<InlineResponse20030>, IValidatableObject
    {
        ...
        public InlineResponse20030(string name = default(string), bool? success = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineResponse20030 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (success == null)
            {
                throw new InvalidDataException("success is a required property for InlineResponse20030 and cannot be null");
            }
            else
            {
