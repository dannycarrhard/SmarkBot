...
namespace IO.Swagger.Model
{
        ...
        public partial class Body17 :  IEquatable<Body17>, IValidatableObject
    {
        ...
        public Body17(string contractId = default(string), string marketId = default(string), int? price = default(int?), int? quantity = default(int?), SideEnum side = default(SideEnum))
        {
            // to ensure "contractId" is required (not null)
            if (contractId == null)
            {
                throw new InvalidDataException("contractId is a required property for Body17 and cannot be null");
            }
            else
            {
            ...
            if (marketId == null)
            {
                throw new InvalidDataException("marketId is a required property for Body17 and cannot be null");
            }
            else
            {
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for Body17 and cannot be null");
            }
            else
            {
                this.Price = price;
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for Body17 and cannot be null");
            }
            else
            {
            ...
            if (side == null)
            {
                throw new InvalidDataException("side is a required property for Body17 and cannot be null");
            }
            else
            {
                this.Side = side;
