...
{
    /// <summary>
    /// PlacedStakeByCurrency
    /// </summary>
    [DataContract]
        public partial class PlacedStakeByCurrency :  IEquatable<PlacedStakeByCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlacedStakeByCurrency" /> class.
        /// </summary>
        ...
        public PlacedStakeByCurrency(int? aUD = default(int?), int? cAD = default(int?), int? cHF = default(int?), int? dKK = default(int?), int? eUR = default(int?), int? gBP = default(int?), int? jPY = default(int?), int? nOK = default(int?), int? sEK = default(int?), int? uSD = default(int?))
        {
            this.AUD = aUD;
            this.CAD = cAD;
            this.CHF = cHF;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlacedStakeByCurrency {\n");
        ...
        {
            return this.Equals(input as PlacedStakeByCurrency);
        }

        /// <summary>
        /// Returns true if PlacedStakeByCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of PlacedStakeByCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlacedStakeByCurrency input)
        {
            if (input == null)
                return false;
