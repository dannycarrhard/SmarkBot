...
namespace IO.Swagger.Model
{
        ...
        public partial class Body13 :  IEquatable<Body13>, IValidatableObject
    {
        ...
        public Body13(string newPassword = default(string), string oldPassword = default(string))
        {
            // to ensure "newPassword" is required (not null)
            if (newPassword == null)
            {
                throw new InvalidDataException("newPassword is a required property for Body13 and cannot be null");
            }
            else
            {
            ...
            if (oldPassword == null)
            {
                throw new InvalidDataException("oldPassword is a required property for Body13 and cannot be null");
            }
            else
            {
