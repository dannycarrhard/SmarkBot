...
namespace IO.Swagger.Test
{
    ...
    public class CountriesApiTests
    {
        ...
        /// </summary>
        [Test]
        public void GetAllowedCountriesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetAllowedCountries();
        ...
        /// </summary>
        [Test]
        public void GetCurrentCountryTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetCurrentCountry();
            //Assert.IsInstanceOf<CurrentCountriesResponse> (response, "response is CurrentCountriesResponse");
        }
        /// <summary>
        /// Test GetPermittedCountries
        /// </summary>
        [Test]
        public void GetPermittedCountriesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetPermittedCountries();
