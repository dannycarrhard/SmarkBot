...
{
    /// <summary>
    /// DepositMethodsResponsePaypal
    /// </summary>
    [DataContract]
        public partial class DepositMethodsResponsePaypal :  IEquatable<DepositMethodsResponsePaypal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositMethodsResponsePaypal" /> class.
        /// </summary>
        ...
        public DepositMethodsResponsePaypal(bool? lastUsed = default(bool?), OneOfdepositMethodsResponsePaypalMaxDeposit maxDeposit = default(OneOfdepositMethodsResponsePaypalMaxDeposit), string methodId = default(string), OneOfdepositMethodsResponsePaypalMinDeposit minDeposit = default(OneOfdepositMethodsResponsePaypalMinDeposit), string payerId = default(string), string providerEmail = default(string))
        {
            // to ensure "lastUsed" is required (not null)
            if (lastUsed == null)
            {
                throw new InvalidDataException("lastUsed is a required property for DepositMethodsResponsePaypal and cannot be null");
            }
            else
            {
            ...
            if (maxDeposit == null)
            {
                throw new InvalidDataException("maxDeposit is a required property for DepositMethodsResponsePaypal and cannot be null");
            }
            else
            {
            ...
            if (methodId == null)
            {
                throw new InvalidDataException("methodId is a required property for DepositMethodsResponsePaypal and cannot be null");
            }
            else
            {
            ...
            if (minDeposit == null)
            {
                throw new InvalidDataException("minDeposit is a required property for DepositMethodsResponsePaypal and cannot be null");
            }
            else
            {
            ...
            if (payerId == null)
            {
                throw new InvalidDataException("payerId is a required property for DepositMethodsResponsePaypal and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("providerEmail is a required property for DepositMethodsResponsePaypal and cannot be null");
            }
            else
            {
        ...
        public OneOfdepositMethodsResponsePaypalMaxDeposit MaxDeposit { get; set; }
        ...
        public OneOfdepositMethodsResponsePaypalMinDeposit MinDeposit { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DepositMethodsResponsePaypal {\n");
        ...
        {
            return this.Equals(input as DepositMethodsResponsePaypal);
        }

        /// <summary>
        /// Returns true if DepositMethodsResponsePaypal instances are equal
        /// </summary>
        /// <param name="input">Instance of DepositMethodsResponsePaypal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepositMethodsResponsePaypal input)
        {
            if (input == null)
                return false;
