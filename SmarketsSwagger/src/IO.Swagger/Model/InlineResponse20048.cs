...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20048 :  IEquatable<InlineResponse20048>, IValidatableObject
    {
        ...
        public InlineResponse20048(string secret = default(string))
        {
            // to ensure "secret" is required (not null)
            if (secret == null)
            {
                throw new InvalidDataException("secret is a required property for InlineResponse20048 and cannot be null");
            }
            else
            {
                this.Secret = secret;
