...
namespace IO.Swagger.Model
{
        ...
        public partial class Body3 :  IEquatable<Body3>, IValidatableObject
    {
        ...
        public Body3(string token = default(string), string xml = default(string))
        {
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new InvalidDataException("token is a required property for Body3 and cannot be null");
            }
            else
            {
                this.Token = token;
            ...
            if (xml == null)
            {
                throw new InvalidDataException("xml is a required property for Body3 and cannot be null");
            }
            else
            {
                this.Xml = xml;
