...
{
    /// <summary>
    /// DepositMethodsResponseNeteller
    /// </summary>
    [DataContract]
        public partial class DepositMethodsResponseNeteller :  IEquatable<DepositMethodsResponseNeteller>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositMethodsResponseNeteller" /> class.
        /// </summary>
        ...
        public DepositMethodsResponseNeteller(bool? lastUsed = default(bool?), OneOfdepositMethodsResponseNetellerMaxDeposit maxDeposit = default(OneOfdepositMethodsResponseNetellerMaxDeposit), string methodId = default(string), OneOfdepositMethodsResponseNetellerMinDeposit minDeposit = default(OneOfdepositMethodsResponseNetellerMinDeposit), string netellerId = default(string))
        {
            // to ensure "lastUsed" is required (not null)
            if (lastUsed == null)
            {
                throw new InvalidDataException("lastUsed is a required property for DepositMethodsResponseNeteller and cannot be null");
            }
            else
            {
            ...
            if (maxDeposit == null)
            {
                throw new InvalidDataException("maxDeposit is a required property for DepositMethodsResponseNeteller and cannot be null");
            }
            else
            {
            ...
            if (methodId == null)
            {
                throw new InvalidDataException("methodId is a required property for DepositMethodsResponseNeteller and cannot be null");
            }
            else
            {
            ...
            if (minDeposit == null)
            {
                throw new InvalidDataException("minDeposit is a required property for DepositMethodsResponseNeteller and cannot be null");
            }
            else
            {
            ...
            if (netellerId == null)
            {
                throw new InvalidDataException("netellerId is a required property for DepositMethodsResponseNeteller and cannot be null");
            }
            else
            {
        ...
        public OneOfdepositMethodsResponseNetellerMaxDeposit MaxDeposit { get; set; }
        ...
        public OneOfdepositMethodsResponseNetellerMinDeposit MinDeposit { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DepositMethodsResponseNeteller {\n");
        ...
        {
            return this.Equals(input as DepositMethodsResponseNeteller);
        }

        /// <summary>
        /// Returns true if DepositMethodsResponseNeteller instances are equal
        /// </summary>
        /// <param name="input">Instance of DepositMethodsResponseNeteller to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepositMethodsResponseNeteller input)
        {
            if (input == null)
                return false;
