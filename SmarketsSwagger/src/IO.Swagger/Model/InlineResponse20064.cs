...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20064 :  IEquatable<InlineResponse20064>, IValidatableObject
    {
        ...
        public InlineResponse20064(Object members = default(Object))
        {
            // to ensure "members" is required (not null)
            if (members == null)
            {
                throw new InvalidDataException("members is a required property for InlineResponse20064 and cannot be null");
            }
            else
            {
