...
namespace IO.Swagger.Model
{
        ...
        public partial class GetFollowersResponse :  IEquatable<GetFollowersResponse>, IValidatableObject
    {
        ...
        public GetFollowersResponse(List<int?> followers = default(List<int?>))
        {
            // to ensure "followers" is required (not null)
            if (followers == null)
            {
                throw new InvalidDataException("followers is a required property for GetFollowersResponse and cannot be null");
            }
            else
            {
