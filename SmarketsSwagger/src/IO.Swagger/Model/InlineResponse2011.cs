...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2011 :  IEquatable<InlineResponse2011>, IValidatableObject
    {
        ...
        public InlineResponse2011(DateTime? stop = default(DateTime?), bool? success = default(bool?))
        {
            // to ensure "stop" is required (not null)
            if (stop == null)
            {
                throw new InvalidDataException("stop is a required property for InlineResponse2011 and cannot be null");
            }
            else
            {
                this.Stop = stop;
            ...
            if (success == null)
            {
                throw new InvalidDataException("success is a required property for InlineResponse2011 and cannot be null");
            }
            else
            {
