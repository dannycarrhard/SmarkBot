...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MethodAddress1 :  IEquatable<MethodAddress1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodAddress1" /> class.
        /// </summary>
        ...
        public MethodAddress1(string buildingName = default(string), string buildingNumber = default(string), string country = default(string), string flatNumber = default(string), string postcode = default(string), string street = default(string), string substreet = default(string), string town = default(string))
        {
            // to ensure "buildingName" is required (not null)
            if (buildingName == null)
            {
                throw new InvalidDataException("buildingName is a required property for MethodAddress1 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("buildingNumber is a required property for MethodAddress1 and cannot be null");
            }
            else
            {
            ...
            if (country == null)
            {
                throw new InvalidDataException("country is a required property for MethodAddress1 and cannot be null");
            }
            else
            {
            ...
            if (flatNumber == null)
            {
                throw new InvalidDataException("flatNumber is a required property for MethodAddress1 and cannot be null");
            }
            else
            {
            ...
            if (postcode == null)
            {
                throw new InvalidDataException("postcode is a required property for MethodAddress1 and cannot be null");
            }
            else
            {
            ...
            if (street == null)
            {
                throw new InvalidDataException("street is a required property for MethodAddress1 and cannot be null");
            }
            else
            {
                this.Street = street;
            ...
            if (substreet == null)
            {
                throw new InvalidDataException("substreet is a required property for MethodAddress1 and cannot be null");
            }
            else
            {
            ...
            if (town == null)
            {
                throw new InvalidDataException("town is a required property for MethodAddress1 and cannot be null");
            }
            else
            {
                this.Town = town;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MethodAddress1 {\n");
        ...
        {
            return this.Equals(input as MethodAddress1);
        }

        /// <summary>
        /// Returns true if MethodAddress1 instances are equal
        /// </summary>
        /// <param name="input">Instance of MethodAddress1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MethodAddress1 input)
        {
            if (input == null)
                return false;
