...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20038 :  IEquatable<InlineResponse20038>, IValidatableObject
    {
        ...
        public InlineResponse20038(string exposure = default(string))
        {
            // to ensure "exposure" is required (not null)
            if (exposure == null)
            {
                throw new InvalidDataException("exposure is a required property for InlineResponse20038 and cannot be null");
            }
            else
            {
