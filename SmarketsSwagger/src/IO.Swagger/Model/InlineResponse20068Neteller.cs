...
{
    /// <summary>
    /// InlineResponse20068Neteller
    /// </summary>
    [DataContract]
        public partial class InlineResponse20068Neteller :  IEquatable<InlineResponse20068Neteller>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20068Neteller" /> class.
        /// </summary>
        ...
        public InlineResponse20068Neteller(bool? lastUsed = default(bool?), OneOfinlineResponse20068NetellerMaxWithdrawal maxWithdrawal = default(OneOfinlineResponse20068NetellerMaxWithdrawal), string methodId = default(string), OneOfinlineResponse20068NetellerMinWithdrawal minWithdrawal = default(OneOfinlineResponse20068NetellerMinWithdrawal), string netellerId = default(string), string withdrawalBalance = default(string))
        {
            // to ensure "lastUsed" is required (not null)
            if (lastUsed == null)
            {
                throw new InvalidDataException("lastUsed is a required property for InlineResponse20068Neteller and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maxWithdrawal is a required property for InlineResponse20068Neteller and cannot be null");
            }
            else
            {
            ...
            if (methodId == null)
            {
                throw new InvalidDataException("methodId is a required property for InlineResponse20068Neteller and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("minWithdrawal is a required property for InlineResponse20068Neteller and cannot be null");
            }
            else
            {
            ...
            if (netellerId == null)
            {
                throw new InvalidDataException("netellerId is a required property for InlineResponse20068Neteller and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("withdrawalBalance is a required property for InlineResponse20068Neteller and cannot be null");
            }
            else
            {
        ...
        public OneOfinlineResponse20068NetellerMaxWithdrawal MaxWithdrawal { get; set; }
        ...
        public OneOfinlineResponse20068NetellerMinWithdrawal MinWithdrawal { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20068Neteller {\n");
        ...
        {
            return this.Equals(input as InlineResponse20068Neteller);
        }

        /// <summary>
        /// Returns true if InlineResponse20068Neteller instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20068Neteller to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20068Neteller input)
        {
            if (input == null)
                return false;
