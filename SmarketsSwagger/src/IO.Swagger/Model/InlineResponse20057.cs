...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20057 :  IEquatable<InlineResponse20057>, IValidatableObject
    {
        ...
        public InlineResponse20057(string pnl = default(string))
        {
            // to ensure "pnl" is required (not null)
            if (pnl == null)
            {
                throw new InvalidDataException("pnl is a required property for InlineResponse20057 and cannot be null");
            }
            else
            {
                this.Pnl = pnl;
