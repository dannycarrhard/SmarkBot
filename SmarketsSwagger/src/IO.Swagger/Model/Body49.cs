...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Body49 :  IEquatable<Body49>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Body49" /> class.
        /// </summary>
        ...
        public Body49(string buildingName = default(string), string buildingNumber = default(string), string country = default(string), string flatNumber = default(string), string nationalId = default(string), V3personalOccupation occupation = default(V3personalOccupation), string phone = default(string), string postcode = default(string), string street = default(string), string substreet = default(string), string town = default(string))
        {
        ...
        public V3personalOccupation Occupation { get; set; }
        ...
        {
            return this.Equals(input as Body49);
        }

        /// <summary>
        /// Returns true if Body49 instances are equal
        /// </summary>
        /// <param name="input">Instance of Body49 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Body49 input)
        {
            if (input == null)
                return false;
