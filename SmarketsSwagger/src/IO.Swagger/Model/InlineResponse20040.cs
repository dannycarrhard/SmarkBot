...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20040 :  IEquatable<InlineResponse20040>, IValidatableObject
    {
        ...
        public InlineResponse20040(List<string> requirements = default(List<string>))
        {
            // to ensure "requirements" is required (not null)
            if (requirements == null)
            {
                throw new InvalidDataException("requirements is a required property for InlineResponse20040 and cannot be null");
            }
            else
            {
