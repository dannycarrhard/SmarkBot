...
{
    /// <summary>
    /// InlineResponse20068Paypal
    /// </summary>
    [DataContract]
        public partial class InlineResponse20068Paypal :  IEquatable<InlineResponse20068Paypal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20068Paypal" /> class.
        /// </summary>
        ...
        /// <param name="providerEmail">providerEmail (required).</param>
        /// <param name="withdrawalBalance">withdrawalBalance (required).</param>
        public InlineResponse20068Paypal(bool? lastUsed = default(bool?), OneOfinlineResponse20068PaypalMaxWithdrawal maxWithdrawal = default(OneOfinlineResponse20068PaypalMaxWithdrawal), string methodId = default(string), OneOfinlineResponse20068PaypalMinWithdrawal minWithdrawal = default(OneOfinlineResponse20068PaypalMinWithdrawal), string payerId = default(string), string providerEmail = default(string), string withdrawalBalance = default(string))
        {
            // to ensure "lastUsed" is required (not null)
            if (lastUsed == null)
            {
                throw new InvalidDataException("lastUsed is a required property for InlineResponse20068Paypal and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("maxWithdrawal is a required property for InlineResponse20068Paypal and cannot be null");
            }
            else
            {
            ...
            if (methodId == null)
            {
                throw new InvalidDataException("methodId is a required property for InlineResponse20068Paypal and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("minWithdrawal is a required property for InlineResponse20068Paypal and cannot be null");
            }
            else
            {
            ...
            if (payerId == null)
            {
                throw new InvalidDataException("payerId is a required property for InlineResponse20068Paypal and cannot be null");
            }
            else
            {
                this.PayerId = payerId;
            }
            // to ensure "providerEmail" is required (not null)
            if (providerEmail == null)
            {
                throw new InvalidDataException("providerEmail is a required property for InlineResponse20068Paypal and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("withdrawalBalance is a required property for InlineResponse20068Paypal and cannot be null");
            }
            else
            {
        ...
        public OneOfinlineResponse20068PaypalMaxWithdrawal MaxWithdrawal { get; set; }
        ...
        public OneOfinlineResponse20068PaypalMinWithdrawal MinWithdrawal { get; set; }
        ...
        /// </summary>
        [DataMember(Name="provider_email", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20068Paypal {\n");
        ...
        {
            return this.Equals(input as InlineResponse20068Paypal);
        }

        /// <summary>
        /// Returns true if InlineResponse20068Paypal instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20068Paypal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20068Paypal input)
        {
            if (input == null)
                return false;
