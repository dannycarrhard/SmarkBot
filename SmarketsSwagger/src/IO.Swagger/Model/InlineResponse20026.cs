...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20026 :  IEquatable<InlineResponse20026>, IValidatableObject
    {
        ...
        public InlineResponse20026(bool? valid = default(bool?))
        {
            // to ensure "valid" is required (not null)
            if (valid == null)
            {
                throw new InvalidDataException("valid is a required property for InlineResponse20026 and cannot be null");
            }
            else
            {
                this.Valid = valid;
