...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse429 :  IEquatable<InlineResponse429>, IValidatableObject
    {
        ...
        public InlineResponse429( data = default(), ErrorTypeEnum errorType = default(ErrorTypeEnum))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for InlineResponse429 and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (errorType == null)
            {
                throw new InvalidDataException("errorType is a required property for InlineResponse429 and cannot be null");
            }
            else
            {
