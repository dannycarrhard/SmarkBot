...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Body57 :  IEquatable<Body57>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Body57" /> class.
        /// </summary>
        /// <param name="amount">amount (required).</param>
        /// <param name="failUrl">failUrl.</param>
        /// <param name="methodId">methodId (required).</param>
        /// <param name="successUrl">successUrl.</param>
        public Body57(string amount = default(string), string failUrl = default(string), string methodId = default(string), string successUrl = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for Body57 and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (methodId == null)
            {
                throw new InvalidDataException("methodId is a required property for Body57 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as Body57);
        }

        /// <summary>
        /// Returns true if Body57 instances are equal
        /// </summary>
        /// <param name="input">Instance of Body57 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Body57 input)
        {
            if (input == null)
                return false;
