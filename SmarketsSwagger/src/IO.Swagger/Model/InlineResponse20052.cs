...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20052 :  IEquatable<InlineResponse20052>, IValidatableObject
    {
        ...
        public InlineResponse20052(List<InlineResponse20052Providers> providers = default(List<InlineResponse20052Providers>))
        {
            // to ensure "providers" is required (not null)
            if (providers == null)
            {
                throw new InvalidDataException("providers is a required property for InlineResponse20052 and cannot be null");
            }
            else
            {
        ...
        public List<InlineResponse20052Providers> Providers { get; set; }
